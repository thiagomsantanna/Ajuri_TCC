...
<div class="container">
    ...
    <div class="quadradinRegistroNAOVOUMEXERNAPONTOCSS">
            ...
            <form style="height: 600px;" name="frmUser" action="registroAdv.php" method="POST" enctype="multipart/form-data">
                <!--NOME USERNAME CPF DATA NASC ENDERECO EMAIL SENHA -->
    ...
    <div class="gridContainer">
        ...
        <div class="gridItem9 form-group">
      ...
      <div class="gridItem10 form-group">
          <input type="text" placeholder="Onde se formou?"  id="formacao" name="formacao" class="form-control04" required>
      </div>
<br>
      <div class="gridItem11 form-group">
      
        <div class="custom-file">
        <h5 class="h5Margin" style="margin-top: 20px;">Selecione uma foto de perfil:</h5>
          <input type="file"  id="imagem" name="imagem" class="custom-file-input" required>
          <label class="custom-file-label" for="imagem" value=""></label>  
          <br>
