...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 26-Nov-2020 às 06:24
...
(45, '', 'somente apenas'),
(46, '', 'kkkkkkk'),
(47, '', 'krl o cara fala sozinho'),
(48, 'Pedro', 'ala ele fala sozin memokkkkkkkkkkkkkkkkkkkkkkkkkkkkkk'),
(49, '', 'jeej'),
(71, 'Lucas', 'miau'),
(81, 'Lucas', ''),
(80, 'Lucas', ''),
...
CREATE TABLE IF NOT EXISTS `cidades` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nome_cidades` varchar(120) DEFAULT NULL,
...
INSERT INTO `cidades` (`id`, `nome_cidades`, `id_estado`) VALUES
(1, 'Afonso Cláudio', 8),
...
CREATE TABLE IF NOT EXISTS `estados` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nome_estados` varchar(75) DEFAULT NULL,
...
INSERT INTO `estados` (`id`, `nome_estados`, `uf`) VALUES
(1, 'Acre', 'AC'),
(2, 'Alagoas', 'AL'),
(3, 'Amazonas', 'AM'),
(4, 'Amapá', 'AP'),
...
--
-- Estrutura da tabela `tbadvogados`
--

DROP TABLE IF EXISTS `tbadvogados`;
CREATE TABLE IF NOT EXISTS `tbadvogados` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `COD_AREA_DIREITO` int(11) NOT NULL,
  `LUGAR_FORMACAO` varchar(150) DEFAULT NULL,
  `TIPO` varchar(8) NOT NULL,
  PRIMARY KEY (`ID`),
  KEY `COD_CIDADE` (`COD_CIDADE`),
  KEY `COD_ESTADO` (`COD_ESTADO`),
  KEY `COD_AREA_DIREITO` (`COD_AREA_DIREITO`)
) ENGINE=MyISAM AUTO_INCREMENT=26 DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `tbadvogados`
--

INSERT INTO `tbadvogados` (`ID`, `NOME`, `USERNAME`, `TELEFONE`, `DATANASC`, `EMAIL`, `SENHA`, `COD_ESTADO`, `COD_CIDADE`, `DESCRICAO`, `IMAGEM`, `COD_AREA_DIREITO`, `LUGAR_FORMACAO`, `TIPO`) VALUES
(3, 'Regis Gustavo', 'root', '123456789', '2001-03-12', 'rogers@jhonson.com', 'regis123', 0, 0, '', NULL, 0, NULL, 'advogado'),
(7, 'João Pedro', 'pizzandrade', '17 98151-9199', '2003-01-26', '03jpac.pa@gmail.com', 'pizza1234', 26, 4758, 'Ã© ele.', 'eelemesmo.jpg', 11, 'sesc - curso ca ivone', 'advogado'),
(12, 'asdfijnwqe', 'jsadnfjqw', '17981783944', '2002-12-10', 'asdfjinkwjqe@gmail.com', 'asdhjfbqwe', 3, 203, NULL, NULL, 11, 'KKKKKKKjjj', 'advogado'),
(11, 'Teste', 'xesque', '17981783944', '2202-12-10', 'xesque@gmail.com', 'sadfwqe', 22, 203, NULL, NULL, 3, 'USP', 'advogado'),
(13, 'RATAO', 'RATAOINSANO', '17981783944', '2002-12-10', 'rato.foda@gmail.com', 'rataokk123', 12, 203, 'eae gatinha ta tudo xesque? no bresque do desque? do plesque do mesque? do dele do dili do doli do joao sao fino do pino pepino menino. quer namorar cmg?', 'ratooculao.jpeg', 6, 'FORMADO NA PUTARIA', 'advogado'),
(14, 'Pedro Quiles', 'pedroOtako', '17 99117-2928', '1984-05-14', 'pedroquiles@gmail.com', 'pedrofoda', 26, 4758, 'sim sou vagal sÃ³ to zuano co perfil aq', 'luffypedro.png', 6, 'vagal', 'advogado'),
(15, 'Thiago Mundici', 'thiagoasdhfbwqe', '(17) 981783944', '2002-12-10', 'thiagomsantanna11@gmail.com', 'thiago11', 26, 5264, NULL, 'calangofoda.jpeg', 11, 'Centro Paula Souza - ETEC Philadelpho GouvÃªa Netto', 'advogado'),
(16, 'Lukas Dyaz', 'mut3dbr', '17 99273-5411', '2003-03-25', 'mutedbitcoin@outlook.com', 'lukas1234', 26, 5264, NULL, 'lukinhasgames.jpeg', 2, 'UNESP - Rio Preto', 'advogado'),
(17, 'Pedro Henrique', 'pedrofoda', '14 99685-7079', '2002-12-10', 'pedrohenrique@gmail.com', '12345', 15, 4413, 'pepeka gordona pike mike tyson', 'weeb4.jpg', 9, 'AAAAA DEU XOXX', 'advogado'),
(18, 'java', 'javascript', '17981783934', '2014-03-07', 'javascript@gmail.com', 'java123', 4, 2784, 'xesque teste', 'safada2.jpeg', 6, 'JavaScript', 'advogado'),
(24, 'Regis Gustavo', 'rogers', '17 99742-5923', '2002-11-27', 'regisg.filho@gmail.com', 'regis1234', 26, 283, 'regis 2k20 5kk mastery points pentakill montage outplayed', 'rogers.jpg', 7, 'nem t conto', 'advogado'),
(25, 'Joao Lucas', 'lucascalistenico', '17 99653-6290', '2002-12-10', 'lucascalistenico@gmail.com', 'lucas1234', 26, 4758, 'pode aplicar', 'lucascalistenia.jpg', 5, 'quer tomar bomba ', 'advogado');
...
INSERT INTO `tbusuario` (`ID`, `NOME`, `USERNAME`, `TELEFONE`, `DATANASC`, `EMAIL`, `SENHA`, `DESCRICAO`, `COD_ESTADO`, `COD_CIDADE`, `IMAGEM`, `TIPO`) VALUES
(1, 'Luis Gustavo', 'luisfoda', '17 98823-3986', '1980-05-31', 'luisaugusto@gmail.com', 'luis1234', 'Ã³ o minato', 11, 516, 'minato.gif', 'usuario'),
(2, 'Lucas Pereira', 'lucaspereira', '14 99685-7078', '1990-07-14', 'lucas.pereira12@gmail.com', 'lucasforte123', 'xique xique', 26, 697, 'eelemesmo.jpg', 'usuario');

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_areas_direito`
--

DROP TABLE IF EXISTS `tb_areas_direito`;
CREATE TABLE IF NOT EXISTS `tb_areas_direito` (
  `id_area` int(11) NOT NULL,
  `area_direito` varchar(33) NOT NULL,
  PRIMARY KEY (`id_area`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `tb_areas_direito`
--

INSERT INTO `tb_areas_direito` (`id_area`, `area_direito`) VALUES
(1, 'Direito Civil'),
(2, 'Direito Penal'),
...
(11, 'Direito da Tecnologia da Informaç'),
(12, 'Direito da Propriedade Intelectua');
COMMIT;
