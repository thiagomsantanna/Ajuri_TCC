...
<form name="frmEditSenha" action="" method="POST">
        ...
        <div class="form-group"> 
          <center>
          <div class="col-md-6">
            <label for="nameuser" style="float:left !important"><i class="far fa-user-circle"></i>&nbsp;-&nbsp;username:</label>
              <input type="text" class="form-control form-control-alternative" id="nameuser" name="nameuser" value="<?php echo $_SESSION['USERNAME'] ?>" required>
          </div>
        </div>
      </center>
      ...
      <center>
          <div class="col-md-6">
            <label for="senha" style="float:left !important"><i class="fas fa-lock"></i>&nbsp;-&nbsp;Nova Senha:</label>

            <input type="password" class="form-control form-control-alternative" id="senha" name="senha" required>
          </div>
      </div>
      </center>
      ...
      <center>
          <div class="col-md-6">
            <label for="senha_confirma" style="float:left !important">Repita Senha:</label>

            <input type="password" class="form-control form-control-alternative" id="senha_confirma" name="senha_confirma" required>
          </div>
      </div>
      </center>
      ...
      <center>
          <div class="col-md-6">
            <label for="email" style="float:left !important"><i class="far fa-envelope-open"></i>&nbsp;-&nbsp;Nova e-mail:</label>

            <input type="text" class="form-control form-control-alternative" id="email" name="email" value="<?php echo $_SESSION['EMAIL'] ?>"required>
          </div>
      </div>
      </center>
