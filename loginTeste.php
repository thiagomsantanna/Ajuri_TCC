...
<!--  H1 can have 2 designs: "logo" and "logo cursive"           -->
    ...
    <div class="content">
      ...
      <h5 class="h5Posicao">Não possui uma conta?</h5>

      <!--onclick="xesque()"-->
          <button class="btnLogin" onclick="xesque()">nova conta</button>
...
<hr class="hr1">
<form method="get" action="loginUser.php" id="formLogin" name="formLogin">

            <!--<center><input type="text"placeholder="Nome" class="form-control"></center>-->
  <center>
      <input type="text" placeholder="Username" class="form-control" name="txtLogin" id="txtLogin">
  </center>

  <center>
    <input type="password" placeholder="Senha" class="form-control" name="txtSenha" id="txtSenha">
  </center>
            
      <hr class="hr">
      <h5 class="h5Margin">
        <a class="" style="color: #0088d7;" href="">Esqueci minha senha.
        </a>
      </h5> 
      ...
      <div class="Container">
        ...
        <div class="Buttons">   
          <button type="submit" class="btnDiv" style="width: 80%;" name="btnLogin">Login
          </button>
        </div>
