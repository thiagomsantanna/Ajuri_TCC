            ...
            <!--Foto de perfil-->
              ...
              <div class="col-lg-4 order-lg-3 text-lg-right align-self-lg-center">
                <div class="card-profile-actions py-4 mt-lg-0">
                  <a href="perfilEditar.php" class="btn btn-sm btn-info mr-4" style="background-color:#336ebe; border-color: #336ebe; float:left"><i class="fas fa-user-edit"></i>&nbsp;Editar perfil</a>
              ...
              <div>
                <br>
                <br>
                <div class="h5 font-weight-300"><i class="ni location_pin mr-2"></i><i class="fas fa-phone-alt"></i>&nbsp;-<?php echo "&nbsp;<strong>".$_SESSION['TELEFONE']."</strong>";?></div>
                </div>
      ...
      <!-- telefone -->
            ...
            <div class="mt-5 py-5 border-top text-center">
              <div class="row justify-content-center">
                <div class="col-lg-9">
					<!--Descrição do perfil -->
                  <p> <?php echo "<strong>".$_SESSION['DESCRICAO']."</strong>";?></p>
                  <!--<a href="#">Editar</a> -->
                </div>
              </div>
            </div>
